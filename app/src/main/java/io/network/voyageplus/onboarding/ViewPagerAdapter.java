...
public class ViewPagerAdapter extends PagerAdapter {
    ...
    int images[] = {
            ...
            R.drawable.onboarding_img_four,
            R.drawable.onboarding_img_two,
            R.drawable.onboarding_img_one,
            R.drawable.onboarding_img_three
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        TextView slideDesciption = (TextView) view.findViewById(R.id.text_description);
